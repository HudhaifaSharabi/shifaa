...
def execute():
	...
	for old, new in doctypes.items():
		if frappe.db.exists("DocType", old) and not frappe.db.exists("DocType", new):
			...
			frappe.reload_doc("shifaa", "doctype", new)
	...
	try:
		...
		frappe.reload_doc("shifaa", "doctype", "Codification Table")
		...
		frappe.reload_doc("shifaa", "doctype", "Shifaa Settings")
		rename_field("Shifaa Settings", "default_medical_code_standard", "default_code_system")
