...
class Analytics(object):
	...
	def get_columns(self):
		...
		if self.filters.tree_type == "Shifaa Practitioner":
			self.columns.append(
				{
					"label": _("Shifaa Practitioner"),
	...
	def get_data(self):
		if self.filters.tree_type == "Shifaa Practitioner":
			self.get_appointments_based_on_shifaa_practitioner()
			self.get_rows()
	...
	def get_appointments_based_on_shifaa_practitioner(self):
