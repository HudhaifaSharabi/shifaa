# Copyright (c) 2021, shifaa and Contributors
# See license.txt
...
from shifaa.shifaa.doctype.clinical_procedure.test_clinical_procedure import (
	create_procedure,
)
...
from shifaa.shifaa.doctype.lab_test.test_lab_test import (
	create_lab_test,
	create_lab_test_template,
)
from shifaa.shifaa.doctype.nursing_task.nursing_task import NursingTask
from shifaa.shifaa.doctype.patient_appointment.test_patient_appointment import (
	create_clinical_procedure_template,
	create_shifaa_docs,
)
from shifaa.shifaa.doctype.therapy_plan.test_therapy_plan import create_therapy_plan
from shifaa.shifaa.doctype.therapy_session.test_therapy_session import (
	create_therapy_session,
)
from shifaa.shifaa.doctype.therapy_type.test_therapy_type import create_therapy_type
...
class TestNursingTask(FrappeTestCase):
	def setUp(self) -> None:
		...
		self.settings = frappe.get_single("Shifaa Settings")
		self.settings.validate_nursing_checklists = 1
		self.settings.save()

		self.patient, self.practitioner = create_shifaa_docs()
