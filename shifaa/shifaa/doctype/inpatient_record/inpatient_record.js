	...
	let dialog = new frappe.ui.Dialog({
		...
		fields: [
			{fieldtype: 'Link', label: 'Service Unit Type', fieldname: 'service_unit_type',
				options: 'Shifaa Service Unit Type', default: frm.doc.admission_service_unit_type
			},
			{fieldtype: 'Link', label: 'Service Unit', fieldname: 'service_unit',
				options: 'Shifaa Service Unit', reqd: 1
			},
...
let transfer_patient_dialog = function(frm) {
	let dialog = new frappe.ui.Dialog({
		...
		width: 100,
		fields: [
			{fieldtype: 'Link', label: 'Leave From', fieldname: 'leave_from', options: 'Shifaa Service Unit', reqd: 1, read_only:1},
			{fieldtype: 'Link', label: 'Service Unit Type', fieldname: 'service_unit_type', options: 'Shifaa Service Unit Type'},
			{fieldtype: 'Link', label: 'Transfer To', fieldname: 'service_unit', options: 'Shifaa Service Unit', reqd: 1},
	...
	dialog.fields_dict['leave_from'].get_query = function(){
		return {
			query : 'shifaa.shifaa.doctype.inpatient_record.inpatient_record.get_leave_from',
