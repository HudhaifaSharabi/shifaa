# Copyright (c) 2023, shifaa and Contributors
# See license.txt
...
from shifaa.shifaa.doctype.lab_test.test_lab_test import create_practitioner
...
class TestObservation(FrappeTestCase):
	...
	def test_single_observation_from_invoice(self):
		frappe.db.set_single_value("Shifaa Settings", "create_observation_on_si_submit", 1)
