...
def return_child_observation_data_as_dict(child_observations, obs, obs_length=0):
	...
	obs_dict = {
		...
		"shifaa_practitioner": obs.get("shifaa_practitioner"),
...
def add_observation(**args):
	...
	observation_doc.shifaa_practitioner = args.get("practitioner")
...
def set_calculated_result(doc):
	if doc.parent_observation:
		...
		settings = frappe.get_cached_doc("Shifaa Settings").as_dict()
