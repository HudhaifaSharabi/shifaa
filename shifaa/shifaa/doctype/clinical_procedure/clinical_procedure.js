...
frappe.ui.form.on('Clinical Procedure', {
	...
	set_procedure_consumables: function(frm) {
		frappe.call({
			method: 'shifaa.shifaa.doctype.clinical_procedure.clinical_procedure.get_procedure_consumables',
			args: {
	...
	set_medical_codes: function(frm) {
		frappe.call({
			"method": "shifaa.shifaa.utils.get_medical_codes",
			args: {
				template_dt: "Clinical Procedure Template",
...
let get_procedure_prescribed = function(frm){
	if(frm.doc.patient){
		frappe.call({
			method:"shifaa.shifaa.doctype.clinical_procedure.clinical_procedure.get_procedure_prescribed",
