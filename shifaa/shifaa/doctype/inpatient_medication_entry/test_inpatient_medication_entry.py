...
from shifaa.shifaa.doctype.inpatient_medication_order.test_inpatient_medication_order import (
	create_ipme,
	create_ipmo,
)
...
def make_stock_entry(warehouse=None):
	...
	expense_account = get_account(None, "expense_account", "Shifaa Settings", "_Test Company")
