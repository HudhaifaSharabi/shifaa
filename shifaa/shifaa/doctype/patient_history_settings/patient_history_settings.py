...
from shifaa.shifaa.page.patient_history.patient_history import get_patient_history_doctypes
...
def set_subject_field(doc):
	...
	if doc.doctype == "Observation":
		subject = frappe.render_template(
			"shifaa/shifaa/doctype/observation/observation.html", dict(doc=doc)
		)
	else:
