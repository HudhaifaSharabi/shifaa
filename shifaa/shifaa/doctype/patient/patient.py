...
class Patient(Document):
	...
	def after_insert(self):
		if frappe.db.get_single_value("Shifaa Settings", "collect_registration_fee"):
	...
	def on_update(self):
		if frappe.db.get_single_value("Shifaa Settings", "link_customer_to_patient"):
			if self.customer:
	...
	def autoname(self):
		patient_name_by = frappe.db.get_single_value("Shifaa Settings", "patient_name_by")
	...
	def invoice_patient_registration(self):
		if frappe.db.get_single_value("Shifaa Settings", "registration_fee"):
...
def make_invoice(patient, company):
	...
	item_line.rate = frappe.db.get_single_value("Shifaa Settings", "registration_fee")
