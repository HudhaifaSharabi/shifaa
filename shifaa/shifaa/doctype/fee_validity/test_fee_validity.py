...
class TestFeeValidity(FrappeTestCase):
	...
	def test_fee_validity(self):
		...
		shifaa_settings = frappe.get_single("Shifaa Settings")
		shifaa_settings.enable_free_follow_ups = 1
		shifaa_settings.max_visits = 1
		shifaa_settings.valid_days = 7
		shifaa_settings.show_payment_popup = 1
		shifaa_settings.op_consulting_charge_item = item
		shifaa_settings.save(ignore_permissions=True)
