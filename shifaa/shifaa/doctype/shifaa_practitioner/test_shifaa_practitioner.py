...
class TestShifaaPractitioner(FrappeTestCase):
			...
			practitioner = frappe.get_doc(
				{
					...
					"first_name": f"__Test Shifaa Practitioner {idx}",
					"gender": "Female",
	...
	def tearDown(cls):
		...
		frappe.db.sql(
			"""delete from `tabShifaa Practitioner` where name like '__Test Shifaa Practitioner%'"""
		)
