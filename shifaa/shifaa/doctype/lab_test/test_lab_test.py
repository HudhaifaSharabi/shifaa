...
from shifaa.shifaa.doctype.patient_medical_record.test_patient_medical_record import (
...
class TestLabTest(FrappeTestCase):
	...
	def test_sample_collection(self):
		frappe.db.set_single_value("Shifaa Settings", "create_sample_collection_for_lab_test", 1)
		lab_template = create_lab_test_template()
		...
		frappe.db.set_single_value("Shifaa Settings", "create_sample_collection_for_lab_test", 0)
		lab_test = create_lab_test(lab_template)
		lab_test.descriptive_test_items[0].result_value = 12
		lab_test.descriptive_test_items[1].result_value = 1
		lab_test.descriptive_test_items[2].result_value = 2.3
...
def create_practitioner():
	practitioner = frappe.db.exists("Shifaa Practitioner", "_Test Shifaa Practitioner")

	if not practitioner:
		practitioner = frappe.new_doc("Shifaa Practitioner")
		practitioner.first_name = "_Test Shifaa Practitioner"
