...
def get_shifaa_service_units(doctype, txt, searchfield, start, page_len, filters):
	table = frappe.qb.DocType("Shifaa Service Unit")
	query = (
	...
	if filters and filters.get("inpatient_record"):
		...
		service_unit = get_current_shifaa_service_unit(filters.get("inpatient_record"))
