...
data = {
	...
	"on_setup": "shifaa.setup.setup_shifaa",
}
...
def setup_shifaa():
	...
	from shifaa.regional.india.abdm.setup import setup as abdm_setup
...
def setup_domain():
	...
	Add Shifaa to active domains in Domain Settings
	"""
	domain = frappe.get_doc("Domain", "Shifaa")
	domain.setup_domain()
...
def create_default_root_service_units():
	from shifaa.shifaa.utils import create_shifaa_service_unit_tree_root

	companies = frappe.get_all("Company")
	for company in companies:
		create_shifaa_service_unit_tree_root(company)
...
def get_patient_history_config():
	return {
		"Patient Encounter": (
			"encounter_date",
			[
				{"label": "Shifaa Practitioner", "fieldname": "practitioner", "fieldtype": "Link"},
		...
		"Clinical Procedure": (
			...
			[
				...
				{"label": "Service Unit", "fieldname": "service_unit", "fieldtype": "Shifaa Service Unit"},
		...
		"Therapy Session": (
			...
			[
				...
				{"label": "Shifaa Service Unit", "fieldname": "service_unit", "fieldtype": "Link"},
				{"label": "Start Time", "fieldname": "start_time", "fieldtype": "Time"},
...
def remove_from_active_domains():
	"""Remove Shifaa from active domains in Domain Settings"""
	frappe.db.delete("Has Domain", {"domain": "Shifaa"})


def remove_portal_settings_menu_items():
	"""Remove menu items added in Portal Settings"""
	menu_items = frappe.get_hooks("standard_portal_menu_items", app_name="shifaa")
